  ...
  <body>
		...
		<div id ="subContentContainer" class="subContainer1">
         	...
         	<div id ="subContentContainer2" class="subContainer2">
				<div class="histlabel"><h1 class="lead" ><span class="glyphicon glyphicon-calendar"></span> Appointment History</h1></div>
					<div id ="apptable" style="display:none;"></div>
			 </div>
...
<link rel="stylesheet" media="screen" href="jquery-handsontable-master/jquery-handsontable-master/dist/jquery.handsontable.full.css">
  ...
  $(window).load(function(){
   			 ...
   			 $.ajax({
				 ...
				 $.ajax({
					type:'POST',
					url: 'appointmenttable.php',
					cache: false,
					success:function(data){
							//alert(data);
							$("#apptable").html(data).show(1000);	
							/*	$('html,body').animate({
							scrollTop: $(".avail").offset().top+100},3500);*/
							}
